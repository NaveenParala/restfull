...
public class ObjectFactory {
    ...
    /**
     * Create an instance of {@link RegisterSvcResType }
     * 
     */
    public RegisterSvcResType createRegisterSvcResType() {
        return new RegisterSvcResType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RegisterSvcResType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.o2.org/RegisterSvc/schema/Res", name = "RegisterSvcRes")
    public JAXBElement<RegisterSvcResType> createRegisterSvcRes(RegisterSvcResType value) {
        return new JAXBElement<RegisterSvcResType>(_RegisterSvcRes_QNAME, RegisterSvcResType.class, null, value);
    }
